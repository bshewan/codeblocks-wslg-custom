 ...
 *
 * $Revision: 13627 $
 * $Id: main.cpp 13627 2025-03-02 18:17:10Z mortenmacfly $
 * $HeadURL: https://svn.code.sf.net/p/codeblocks/code/branches/release-25.03/src/src/main.cpp $
 */
       ...
       m_pBatchBuildDialog(nullptr)
{
    ...
    // WSLg/Wayland compatibility: Use rectangle hints for better compatibility
    unsigned int flags = m_LayoutManager.GetFlags();
    flags |= wxAUI_MGR_RECTANGLE_HINT;       // Simple rectangle hints (most compatible)
    flags &= ~wxAUI_MGR_TRANSPARENT_HINT;    // Disable transparent hints
    flags &= ~wxAUI_MGR_VENETIAN_BLINDS_HINT; // Disable venetian blinds
    flags &= ~wxAUI_MGR_HINT_FADE;           // Disable fade
